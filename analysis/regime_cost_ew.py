...
兩份輸出的差別很大，且方向相反，故兩者都要看：
  ...
  | DL-THR 提高 break-even | 2/4 | **5/5** |
  | 成本餘裕 | 1.3 ~ 17.9 bps | **−1.8 ~ +2.4 bps** |

增益的兩項宣稱在等權口徑下更乾淨也更強；但成本餘裕大幅縮水——最佳格的
6.5–12.8 bps 內含 15 選 1 的選擇偏誤，等權口徑下三個 Z-Score 臂的餘裕已為負。
後者與全篇「等權絕對報酬約等於零」本來就該對得上。
