...
| :--- | :--- | :--- | :--- |
| 摘要（中英） | `00_摘要.md` | — | — |
| 參考文獻 | `13_參考文獻.md` | 併入 ch2 末四頁 | 併入 ch2 |
...
| 附錄 F　兩年形成期延伸研究 | `12_附錄F_兩年形成期延伸研究.md` | — | — |
...
> 附錄 F 同樣**只有散文稿**，判準寫於結果之前（`dev/fw504_all/PLAN.md`）。
> 與附錄 E 相反，它的 19 條新方法是可被挑選的候選策略，故**計入**試驗宇宙
> （$N$ 53 → 72）；5.1.2 節的表維持 2026-09-01 的清點並加註指向附錄 F。
> 若日後重新釘死 `analysis/regime_cost_dsr_eval.py` 的 `TRIAL_CENSUS`，須同步改寫 5.1.2 節。
