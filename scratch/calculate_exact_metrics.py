...
# Also print by exact year (calendar year return)
print("\nCalendar Year NAV values:")
for yr, val in years_series.items():
    print(f"  {yr.year}: NAV = {val:.6f}")
